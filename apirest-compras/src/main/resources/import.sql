...
INSERT INTO clientes (nombre,apellidos,empresa,puesto,cp,provincia,telefono,fecha_nacimiento) values('Pelayo','Saiergo Alonso','Capgemini','Electricista',33041,'Asturias',6666666,'1995-03-14');
INSERT INTO clientes (nombre,apellidos,empresa,puesto,cp,provincia,telefono,fecha_nacimiento) values('Pablo','Garcia Alvarez','Capgemini','Camionero',33321,'Asturias',7777777,'1995-03-10');
...
INSERT INTO compras (cliente_id, articulo_id, fecha, unidades) values (1, 1, '2022-03-02', 5)
